    ...
    <table>
      <tr>
        ...
        <td><a href="https://en.wikipedia.org/wiki/C%2B%2B" target="_blank">
          <img src="assets/Cpp.png" alt="C++_computer_language" width="55" height="60">&nbsp&nbsp&nbsp
        </a></td>
        <td><a href="https://www.python.org/" target="_blank">
          <img src="assets/python.png" alt="python_computer_language" width="55" height="60">&nbsp&nbsp&nbsp
        </a></td>
        <td><a href="https://en.wikipedia.org/wiki/HTML" target="_blank">
